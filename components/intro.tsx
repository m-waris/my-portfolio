  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          >
            <Image
              ...
              className="w-32 rounded-full border-[0.35rem] border-white shadow-xl"
            />
          </motion.div>
        </div>
      </div>
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none  hover:bg-black active:scale-105 transition"
          onClick={() => {
